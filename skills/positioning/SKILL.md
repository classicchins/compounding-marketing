...
2. Note existing positioning statement (if any)
3. Gather any competitive research or customer insights
4. Understand the product capabilities clearly
...
3. **Value** — What each unique attribute enables for customers
...
**Options:**
1. **Existing category** — Compete in a well-defined space (e.g., "project management")
2. **Adjacent category** — Position at the intersection (e.g., "project management for creative teams")
3. **New category** — Create a new category (risky, requires education)
...
**Category Type:** [Existing / Adjacent / New]
```

---

### Step 6: Draft Positioning Statement
...
Acme automatically syncs project status from your existing tools.
```
...
*This positioning canvas should be revisited quarterly or when entering new markets.*
```
