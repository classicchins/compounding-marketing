...
Compounding Marketing is a Claude Code / ChatGPT / Cursor plugin providing 61 marketing skills and 13 workflow commands for SaaS marketing. It is **not a traditional codebase** — it's a structured knowledge system where skills are SKILL.md files and workflows are command `.md` files.
...
commands/         # 13 workflow commands (cm-*.md files invoked via /cm-*)
